...
import 'package:first_project/screens/login/put_password.dart';
              ...
              Column(
                ...
                children: [
                 ...
                 const OtpBase(),
                    ...
                    children: [
                      Padding(
                        ...
                        child: ElevatedButtonBase(
                          text: 'Xác thực',
                          onPressed: () {
                            Navigator.pushReplacement(context, MaterialPageRoute(builder: (context)=> const PutPasswordScreen()));
                          },
                        ),
                      ),
                       Padding(
                  ...
                  TextButtonBase(text: 'Thay đổi thông tin đăng ký', onPressed: (){}),
                    ],
                  ),
